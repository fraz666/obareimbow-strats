  ...
  return (
    <div class="min-h-screen bg-gray-900 text-white">
      <Head>
        ...
        <meta name="description" content="Plan and draw your Rainbow Six Siege attack and defense strategies on interactive maps" />
      </Head>
      ...
      <main class="container mx-auto px-4 py-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div class="text-center p-6 bg-gray-800 rounded-lg">
            ...
            <p class="text-gray-400">
              Draw attack routes, defense positions, and callouts directly on maps
            </p>
          </div>
        ...
        <div class="text-center">
          ...
          <div class="flex justify-center gap-4">
            <a href="/map/bank" class="bg-gray-800 hover:bg-gray-700 p-4 rounded-lg transition-colors">
              <div class="font-semibold">Bank</div>
              <div class="text-sm text-gray-400">4 floors</div>
            </a>
            <a href="/map/clubhouse" class="bg-gray-800 hover:bg-gray-700 p-4 rounded-lg transition-colors">
